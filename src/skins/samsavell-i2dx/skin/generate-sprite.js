...
function place (ctx, prefix, filename, dx, dy) {
  ...
  console.log(
    prefix + ' { background-position: ' + (-dx) + 'px ' + (-dy) + 'px; }'
  )
}
...
(function () {
  ...
  place(
    ...
    '.component[data-name="turntable"][data-placement="left"][data-state="cw"],\n' +
      '.component[data-name="turntable"][data-placement="right"][data-state="ccw"]',
    'scratch-up.png',
    256 * 1,
    0
  )
  place(
    ...
    '.component[data-name="turntable"][data-placement="left"][data-state="ccw"],\n' +
      '.component[data-name="turntable"][data-placement="right"][data-state="cw"]',
    'scratch-down.png',
    256 * 2,
    0
  )
